...
* **기능작성**
    ...
    |-----|-----|-----|:-----:|:-----:|
    |19/19|22/22|2/2|14/16| /24|</br>

    ***transaction 필요한 곳**
    - member.js : 회원 로그인, 
    - board.js : 문의게시판 업로드, 문의 게시판 내용수정, 아이디어 업로드
    ...
    - 04/12
        - 파일 업로드 transaction 알아보기
        - 세션 부분 app.js로 수정해서 옮겼더니 모든 rotes 파일에 적용이 됐다. 적용해서 다른 설정 부분들도 시도해보자. → 쿼리문 2개 나오면 무조건 써야할듯.. 에러 발생시 이전 쿼리문이 입력 되기 때문
